...
@TeleOp (name = "emmaTeleOp")
public class emmaTeleOp extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad1.y) {
            wobbleGrabber.setPosition(1); //grab the wobble goal
        } else {
            wobbleGrabber.setPosition(0); // neutral positison
        ...
        if (gamepad1.right_trigger > 0.1) {
            ...
            roller.setPower(-gamepad1.left_trigger); // spit out
        } else {
            roller.setPower(0);
        }
        ...
        if (gamepad1.b) {
            ...
            positioner.setPosition(0); // Neutral positions; ring falls down into place
        }
        // shoot
